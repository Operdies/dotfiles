...
static const float *rootcolor             = col_Mantle;
static const float *bordercolor           = col_Overlay0;
static const float *focuscolor            = col_Mauve;
...
static const int natural_scrolling_mouse = 0;
...
static void AdjustBrightness(const Arg *a) {
  char cmdbuf[100];
  char *flag = a->i > 0 ? "inc" : "dec";
  int amount = a->i > 0 ? a->i : -a->i;
  sprintf(cmdbuf, "~/.config/sxhkd/scripts/backlight.sh --%s %d", flag, amount);
  system(cmdbuf);
}
...
static const Key keys[] = {
	...
	{ 0,                         XKB_KEY_XF86MonBrightnessDown, AdjustBrightness, { .i = -5 } },
	{ 0,                         XKB_KEY_XF86MonBrightnessUp,   AdjustBrightness, { .i = 5 } },
